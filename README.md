...
Este projeto tem como objetivo implementar progressivamente e de forma didática uma aplicação web inspirada em registrar e consultar treinamentos físicos afim de criar treinos, progedir seções anteriores e consultar exercícios.
